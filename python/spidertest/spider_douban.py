...
class MovieActor:
    ...
    def parse_actor_content_url(self, url):
        ...
        if not div_level_str:
            ...
            return
        actor_summary = div_level_str.find('div', class_='bd') if not div_level_str.find('span',
                                                                                         class_='all hidden') else div_level_str.find(
            'span', class_='all hidden')
    ...
    def main(self):
        ...
        file_count = int(url_count / 2000)  # 338000
